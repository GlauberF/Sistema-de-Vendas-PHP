...
<div id="register_wrapper">
	...
	<div id="show_suspended_sales_button">
		<?php echo anchor("sales/suspended/width:425",
			"<div class='btn btn-primary'><span style='font-size:73%;'>".$this->lang->line('sales_suspended_sales')."</span></div>",
	...
	<?php echo form_input(array('name'=>'item','id'=>'item','size'=>'40','class'=>'input-xxlarge'));?>
...
<div>
		...
		<?php echo anchor("customers/view/-1/width:350",
			"<div class='btn btn-primary'><span>".$this->lang->line('sales_new_customer')."</span></div>",
			array('class'=>'thickbox none','title'=>$this->lang->line('sales_new_customer')));
			?>
		</div>
<div id="new_item_button_register" >
		<?php echo anchor("items/view/-1/width:360",
			"<div class='btn btn-primary'><span>".$this->lang->line('sales_new_item')."</span></div>",
